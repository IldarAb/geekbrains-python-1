...
class Cell:
    ...
    def __sub__(self, other):
        if (self.quantity - other.quantity) > 0:
            return f'Разность двух клеток равна: {self.quantity - other.quantity}'
        else:
            print('Разность двух клеток отрицательна или равна нулю!')

    def __mul__(self, other):
        return f'Результат умножения двух клеток равен: {self.quantity * other.quantity}'

    def __truediv__(self, other):
        return f'Результат целочисленного деления двух клеток равен: {self.quantity // other.quantity}'

    def make_order(self, cells_in_row):
        result_row = ''
        for i in range(int(self.quantity / cells_in_row)):
            result_row += f'{"*" * cells_in_row}\\n'
        result_row += f'{"*" * (self.quantity % cells_in_row)}'
        return result_row
